...
float bank_function(float current_balance)
{
    cout << endl;
    cout << "|-------------------------------------------------------------------"
            "----|"
    ...
    else if (choice == 2)
    {
        ...
        cout << deposit << " $ has been added to your account. Your new balance is :: " << current_balance << "$ " << endl;
    }
    else if (choice == 3)
    {
        float amount;
        ...
        cout << amount << " $ has been transferred to the beneficiary account. Your new balance is :: " << current_balance << "$ " << endl;
    }
