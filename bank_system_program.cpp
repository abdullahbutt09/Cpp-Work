...
void bank_function()
{
    ...
    cout << "|---------------> PRESS 3 TO TRANSFER MONEY TO A ACCOUNT <--------------|" << endl;
    cout << "|---------------> PRESS 4 TO TAKE YOUR CARD BACK <----------------------|" << endl;
    cout << "|                                                                       |" << endl;
    cout << "|-----------------------------------------------------------------------|" << endl;
    ...
    else if (choice == 2)
    {
        ...
        if (paka == "yes" || paka == "y")
        {
            cout << deposit << "rs has been added to your account your new balance is " << current_balance + deposit << "rs " << endl;
            string check_other;
            cout << "Would you like to perform any other action? yes/no y/n :: ";
            cin >> check_other;
        ...
        {
            cout << "Deposit of amount " << deposit << "rs has been cancelled successfully" << endl;
            string check_other;
            cout << "Would you like to perform any other action? yes/no y/n :: ";
            cin >> check_other;
            if (check_other == "yes" || check_other == "y")
    ...
    else if (choice == 3)
    {
        ...
        cout << "You want to transfer " << amount << "rs "
             << "from your account to another account? yes/no | y/n :: ";
        string paka;
        cin >> paka;
        if (paka == "yes" || paka == "y")
        {
            cout << amount << "rs has been transferred to the beneficary account and will be in its account in within 30 mins" << endl;
